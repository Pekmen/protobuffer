...
export const Configuration = ($root.Configuration = (() => {
  ...
  Object.defineProperty(Configuration.prototype, "feedback", {
    get: $util.oneOfGetter(
      ($oneOfFields = ["audibleFeedback", "visibleFeedback"])
    ),
  ...
  Configuration.encode = function encode(message, writer) {
    ...
    if (
      message.audibleFeedback != null &&
      Object.hasOwnProperty.call(message, "audibleFeedback")
    )
      writer.uint32(/* id 3, wireType 0 =*/ 24).int32(message.audibleFeedback);
    if (
      message.visibleFeedback != null &&
      Object.hasOwnProperty.call(message, "visibleFeedback")
    )
  ...
  Configuration.decode = function decode(reader, length) {
    ...
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.Configuration();
  ...
  Configuration.verify = function verify(message) {
    ...
    if (message.timeout != null && message.hasOwnProperty("timeout"))
      if (!$util.isInteger(message.timeout)) return "timeout: integer expected";
    ...
    if (
      message.audibleFeedback != null &&
      message.hasOwnProperty("audibleFeedback")
    ) {
    ...
    if (
      message.visibleFeedback != null &&
      message.hasOwnProperty("visibleFeedback")
    ) {
      if (properties.feedback === 1) return "feedback: multiple values";
      properties.feedback = 1;
  ...
  Configuration.fromObject = function fromObject(object) {
    if (object instanceof $root.Configuration) return object;
    ...
    if (
      ...
      object.audibleFeedback =
        options.enums === String
          ? $root.Configuration.AudibleFeedback[message.audibleFeedback]
          : message.audibleFeedback;
      if (options.oneofs) object.feedback = "audibleFeedback";
    }
    if (
      message.visibleFeedback != null &&
      message.hasOwnProperty("visibleFeedback")
    ) {
      object.visibleFeedback =
        options.enums === String
          ? $root.Configuration.VisibleFeedback[message.visibleFeedback]
          : message.visibleFeedback;
      if (options.oneofs) object.feedback = "visibleFeedback";
    }
    return object;
  };
